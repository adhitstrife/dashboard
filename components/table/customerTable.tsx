...
import { ActionIcon, Badge, Box, Button, Group, Pagination, Table, Text, Tooltip } from "@mantine/core"
import { IconCheck, IconEdit, IconEye, IconPencil, IconTrash, IconUserPin } from "@tabler/icons-react"
                                                    ...
                                                    <Group>
                                                        {customer.status == "In Review" ? (
                                                            ...
                                                            <Tooltip label="Assign To Sales">
                                                                <ActionIcon onClick={() => onAssignSales(customer.id)} variant="transparent">
                                                                    <IconUserPin color="green" size={20} stroke={1.5} />
                                                                </ActionIcon>
                                                            </Tooltip>
                                                        ) : ''}
                                                        <Tooltip label="Customer Details">
                                                            <ActionIcon component={Link} href={`/dashboard/customer/${customer.id}`} variant="transparent">
